        ...
        <header className="flex flex-col md:flex-row items-center gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <Button variant="ghost" size="icon" asChild><a href={`mailto:${user.email}`}><Mail className="w-5 h-5 text-gray-600" /></a></Button>
              <Button variant="ghost" size="icon" asChild><a href="#"><Linkedin className="w-5 h-5 text-gray-600" /></a></Button>
              <Button variant="ghost" size="icon" asChild><a href="#"><Twitter className="w-5 h-5 text-gray-600" /></a></Button>
            </div>
          </div>
        </header>
